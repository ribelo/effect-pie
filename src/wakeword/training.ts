...
- \`bun run cli -- wakeword-train --name ${plan.modelName}\`
...
- \`bun run cli -- wakeword-train --name ${plan.modelName} --register\`
...
- \`bun run cli -- wakeword --models ${plan.outputModelFileName} --duration 20\`
`;
