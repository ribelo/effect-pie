...
export const PA_STREAM_DESCRIPTOR = {
  LENGTH: 0,
  CHANNEL: 1,
  OFFSET_HI: 2,
  OFFSET_LO: 3,
...
export type PA_STREAM_DESCRIPTOR = (typeof PA_STREAM_DESCRIPTOR)[keyof typeof PA_STREAM_DESCRIPTOR]
...
export type PA_TAG = (typeof PA_TAG)[keyof typeof PA_TAG]

export const PA_COMMAND = {
  ERROR: 0,
  TIMEOUT: 1,
  REPLY: 2,
...
export type PA_COMMAND = (typeof PA_COMMAND)[keyof typeof PA_COMMAND]

export const PA_SAMPLE_FORMAT = {
  U8: 0,
  ALAW: 1,
  ULAW: 2,
  S16LE: 3,
...
export type PA_SAMPLE_FORMAT = (typeof PA_SAMPLE_FORMAT)[keyof typeof PA_SAMPLE_FORMAT]
