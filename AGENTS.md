...
effect-pi is a TypeScript/Effect 4.0 port of [PIE](../pie) (Personal Intelligence Engine) -- a voice-activated personal AI assistant for Linux with audio capture, wake-word detection, and AI routing via command pipelines.

## Reference Code

- **Original Rust implementation**: `../pie/` (source of truth for features/spec)
